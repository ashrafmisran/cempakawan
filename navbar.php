    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
          <a class="dropdown-item" href="?m=add-student">New student</a>
          <a class="dropdown-item" href="?m=enroll-student">New enrollment</a>
          <div role="separator" class="dropdown-divider"></div>
          <a class="dropdown-item" href="?m=add-tutor">New tutor</a>
          <a class="dropdown-item" href="?m=add-class">New class</a>
        </div>
      </li>
      <li class="nav-item dropdown">

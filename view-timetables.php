<main class="m-2">
	...
	<div class="input-group mb-2">
		...
		<select id="room" class="form-control ml-2">
	...
	<table class="table table-hover table-striped w-100 table-responsive table-bordered">
		<thead>
			<tr>
				<th></th>
				<th>0800-0900</th>
		...
		<tbody>
			...
			<tr>
				...
				<td></td>
				<td></td>
				<td colspan="2"><span class="badge badge-primary w-100">CLS1001</span></td>
			</tr>
			<tr>
				<th>Friday</th>
				<td></td>
